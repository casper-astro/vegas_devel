...
xlsub2_dual_bit_reverse_out1 = xSignal('xlsub2_dual_bit_reverse_out1');
...
xlsub2_dual_bit_reverse_out3 = xSignal('xlsub2_dual_bit_reverse_out3');
...
xlsub2_dual_bit_reverse_out2 = xSignal('xlsub2_dual_bit_reverse_out2');
...
xlsub2_Relational1_out1 = xSignal('xlsub2_Relational1_out1');
...
xlsub2_Mux2_out1 = xSignal('xlsub2_Mux2_out1');
...
xlsub2_complex_addsub_out1 = xSignal('xlsub2_complex_addsub_out1');
xlsub2_complex_addsub_out2 = xSignal('xlsub2_complex_addsub_out2');
xlsub2_double_delay_bram_fast_out1 = xSignal('xlsub2_double_delay_bram_fast_out1');
xlsub2_double_delay_bram_fast_out2 = xSignal('xlsub2_double_delay_bram_fast_out2');
...
xlsub2_complex_addsub1_out1 = xSignal('xlsub2_complex_addsub1_out1');
xlsub2_complex_addsub1_out2 = xSignal('xlsub2_complex_addsub1_out2');
...
xlsub2_reorder2_out2 = xSignal('xlsub2_reorder2_out2');
xlsub2_reorder2_out3 = xSignal('xlsub2_reorder2_out3');
xlsub2_reorder2_out4 = xSignal('xlsub2_reorder2_out4');
xlsub2_reorder2_out5 = xSignal('xlsub2_reorder2_out5');
...
xlsub3_Shift1_out1 = xSignal('xlsub3_Shift1_out1');
...
xlsub3_Shift2_out1 = xSignal('xlsub3_Shift2_out1');
...
xlsub3_Shift3_out1 = xSignal('xlsub3_Shift3_out1');
xlsub3_Convert3_out1 = xSignal('xlsub3_Convert3_out1');
...
xlsub3_dsp48_complex_add_out1 = xSignal('xlsub3_dsp48_complex_add_out1');
...
xlsub3_dsp48_complex_add_out3 = xSignal('xlsub3_dsp48_complex_add_out3');
...
xlsub3_dsp48_complex_add_out4 = xSignal('xlsub3_dsp48_complex_add_out4');
...
xlsub3_dsp48_complex_add_out2 = xSignal('xlsub3_dsp48_complex_add_out2');
...
xlsub3_c_to_ri_out1 = xSignal('xlsub3_c_to_ri_out1');
xlsub3_c_to_ri_out2 = xSignal('xlsub3_c_to_ri_out2');
...
xlsub3_c_to_ri1_out1 = xSignal('xlsub3_c_to_ri1_out1');
xlsub3_c_to_ri1_out2 = xSignal('xlsub3_c_to_ri1_out2');
xlsub3_c_to_ri1 = xBlock(struct('source', 'monroe_library/c_to_ri', 'name', 'c_to_ri1'), ...
                         struct('n_bits', BitWidth, ...
                                'bin_pt', BitWidth-1), ...
                         {xlsub3_b}, ...
...
xlsub4_apbw_re_slice1_out1 = xSignal('xlsub4_apbw_re_slice1_out1');
...
xlsub4_apbw_re_slice_out1 = xSignal('xlsub4_apbw_re_slice_out1');
...
xlsub4_a5_out1 = xSignal('xlsub4_a5_out1');
...
xlsub4_b5_out1 = xSignal('xlsub4_b5_out1');
...
xlsub4_alucode8_out1 = xSignal('xlsub4_alucode8_out1');
...
xlsub4_opcode8_out1 = xSignal('xlsub4_opcode8_out1');
xlsub4_carryin8_out1 = xSignal('xlsub4_carryin8_out1');
xlsub4_carryinsel8_out1 = xSignal('xlsub4_carryinsel8_out1');
xlsub4_apbw_out1 = xSignal('xlsub4_apbw_out1');
...
xlsub3_Constant1_out1 = xSignal('xlsub3_Constant1_out1');
...
xlsub3_Constant5_out1 = xSignal('xlsub3_Constant5_out1');
xlsub3_Mux_out1 = xSignal('xlsub3_Mux_out1');
xlsub3_Concat2_out1 = xSignal('xlsub3_Concat2_out1');
...
xlsub3_post_sync_delay1_out1 = xSignal('xlsub3_post_sync_delay1_out1');
...
xlsub3_Counter1_out1 = xSignal('xlsub3_Counter1_out1');
...
xlsub3_delay_din0_out1 = xSignal('xlsub3_delay_din0_out1');
xlsub3_delay_din1_out1 = xSignal('xlsub3_delay_din1_out1');
...
xlsub3_Inverter_out1 = xSignal('xlsub3_Inverter_out1');
...
xlsub3_bit_reverse_out1 = xSignal('xlsub3_bit_reverse_out1');
...
xlsub3_bit_reverse1_out1 = xSignal('xlsub3_bit_reverse1_out1');
xlsub3_Mux1 = xBlock(struct('source', 'Mux', 'name', 'Mux1'), ...
                     [], ...
                     {xlsub3_Inverter_out1, xlsub3_Slice4_out1, xlsub3_bit_reverse1_out1}, ...
                     {xlsub3_Mux1_out1});
...
xlsub3_sync_delay_fast_out1 = xSignal('xlsub3_sync_delay_fast_out1');
...
xlsub3_subsystem5_out1 = xSignal('xlsub3_subsystem5_out1');
...
xlsub3_Delay3_out1 = xSignal('xlsub3_Delay3_out1');
...
xlsub3_Delay4_out1 = xSignal('xlsub3_Delay4_out1');
...
xlsub3_Delay5_out1 = xSignal('xlsub3_Delay5_out1');
...
xlsub3_Delay6_out1 = xSignal('xlsub3_Delay6_out1');
...
xlsub3_sel_gen_out1 = xSignal('xlsub3_sel_gen_out1');
...
xlsub3_dsp48_negate_dual_out2 = xSignal('xlsub3_dsp48_negate_dual_out2');
xlsub3_Mux1 = xBlock(struct('source', 'Mux', 'name', 'Mux1'), ...
                     struct('arith_type', 'Signed  (2''s comp)', ...
                            'n_bits', 8, ...
                            'bin_pt', 2), ...
...
xlsub3_sel_gen2_out1 = xSignal('xlsub3_sel_gen2_out1');
...
xlsub3_dsp48_negate_dual1_out2 = xSignal('xlsub3_dsp48_negate_dual1_out2');
...
xlsub3_subsystem5_out2 = xSignal('xlsub3_subsystem5_out2');
...
xlsub4_Constant3_out1 = xSignal('xlsub4_Constant3_out1');
...
xlsub4_Counter_out1 = xSignal('xlsub4_Counter_out1');
...
xlsub4_Delay9_out1 = xSignal('xlsub4_Delay9_out1');
...
xlsub4_Delay8_out1 = xSignal('xlsub4_Delay8_out1');
...
xlsub4_Delay7_out1 = xSignal('xlsub4_Delay7_out1');
...
xlsub3_delay_din0_out1 = xSignal('xlsub3_delay_din0_out1');
xlsub3_delay_din1_out1 = xSignal('xlsub3_delay_din1_out1');
xlsub3_Concat_out1 = xSignal('xlsub3_Concat_out1');
...
xlsub3_delay_din2_out1 = xSignal('xlsub3_delay_din2_out1');
xlsub3_delay_din3_out1 = xSignal('xlsub3_delay_din3_out1');
xlsub3_Concat1_out1 = xSignal('xlsub3_Concat1_out1');
xlsub3_Concat1 = xBlock(struct('source', 'Concat', 'name', 'Concat1'), ...
                        [], ...
...
xlsub3_Constant7_out1 = xSignal('xlsub3_Constant7_out1');
xlsub3_pre_sync_delay2_out1 = xSignal('xlsub3_pre_sync_delay2_out1');
xlsub3_Concat3_out1 = xSignal('xlsub3_Concat3_out1');
...
xlsub3_Constant6_out1 = xSignal('xlsub3_Constant6_out1');
...
xlsub3_Dual_Port_RAM_out1 = xSignal('xlsub3_Dual_Port_RAM_out1');
xlsub3_Dual_Port_RAM_out2 = xSignal('xlsub3_Dual_Port_RAM_out2');
xlsub3_Dual_Port_RAM = xBlock(struct('source', 'Dual Port RAM', 'name', 'Dual Port RAM'), ...
                              struct('depth', 2^(FFTSize), ...
                                     'latency', bram_latency, ...
                                     'write_mode_A', 'Read Before Write', ...
...
xlsub3_apbw_re_slice1 = xBlock(struct('source', 'Slice', 'name', 'apbw_re_slice1'), ...
...
xlsub3_apbw_re_slice2 = xBlock(struct('source', 'Slice', 'name', 'apbw_re_slice2'), ...
                               struct('nbits', din_bit_width*2, ...
                                      'mode', 'Lower Bit Location + Width', ...
...
xlsub3_apbw_re_slice3 = xBlock(struct('source', 'Slice', 'name', 'apbw_re_slice3'), ...
                               struct('nbits', din_bit_width*2, ...
                                      'mode', 'Lower Bit Location + Width'), ...
...
xlsub3_apbw_re_slice4 = xBlock(struct('source', 'Slice', 'name', 'apbw_re_slice4'), ...
                               struct('nbits', din_bit_width*2, ...
                                      'mode', 'Lower Bit Location + Width', ...
                                      'bit0', din_bit_width*2), ...
                               {xlsub3_Dual_Port_RAM_out2}, ...
...
xlsub3_sync_delay_en_out1 = xSignal('xlsub3_sync_delay_en_out1');
xlsub3_post_sync_delay = xBlock(struct('source', 'Delay', 'name', 'post_sync_delay'), ...
...
xlsub3_addresser1_out1 = xSignal('xlsub3_addresser1_out1');
...
xlsub3_addresser_out1 = xSignal('xlsub3_addresser_out1');
...
xlsub3_sync_tree_out1 = xSignal('xlsub3_sync_tree_out1');
...
xlsub3_sync_tree_out2 = xSignal('xlsub3_sync_tree_out2');
...
xlsub4_Counter1_out1 = xSignal('xlsub4_Counter1_out1');
...
xlsub4_Slice1_out1 = xSignal('xlsub4_Slice1_out1');
xlsub4_Slice2_out1 = xSignal('xlsub4_Slice2_out1');
