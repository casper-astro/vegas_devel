function biplex_stage_n_draw(FFTSize, FFTStage, input_bit_width, coeff_bit_width, output_bit_width, delays_bram, bram_latency, shift, delay_arr)
...
xlsub2_ddbf_out2 = xSignal('xlsub2_ddbf_out2');
xlsub2_delay_start_out1 = xSignal('xlsub2_delay_start_out1');
...
xlsub2_Mux1_out1 = xSignal('xlsub2_Mux1_out1');
...
xlsub2_delay_start1_out1 = xSignal('xlsub2_delay_start1_out1');
xlsub2_ddbf_out1 = xSignal('xlsub2_ddbf_out1');
...
if(long_delay_len > 16)
    ...
    xlsub2_delay_end = xBlock(struct('source', 'Delay', 'name', 'delay_ddbf_1'), ...
                          struct('latency', long_delay_len), ...
                          {xlsub2_Mux1_out1}, ...
                          {xlsub2_ddbf_out1});
    xlsub2_delay_end1 = xBlock(struct('source', 'Delay', 'name', 'delay_ddbf_2'), ...
                          struct('latency', long_delay_len), ...
                          {xlsub2_delay_start1_out1}, ...
                          {xlsub2_ddbf_out2});
end
...
xlsub2_delay_end = xBlock(struct('source', 'Delay', 'name', 'delay_end'), ...
                          struct('latency', delay_end_apbw), ...
                          {sTwid_apbw_out}, ...
                          {oApBW});

% block: fft_stage_n_improved/fft_stage_6/delay_end1

xlsub2_delay_end1 = xBlock(struct('source', 'Delay', 'name', 'delay_end1'), ...
                           struct('latency', delay_end_ambw), ...
                           {sTwid_ambw_out}, ...
                           {oAmBW});
...
xlsub2_delay_mid_out1 = xSignal('xlsub2_delay_mid_out1');
xlsub2_delay_mid = xBlock(struct('source', 'Delay', 'name', 'delay_mid'), ...
                          struct('latency', extra_delay_buttCheap+delay_arr(2)), ...
                          {xlsub2_ddbf_out1}, ...
                          {xlsub2_delay_mid_out1});

% block: fft_stage_n_improved/fft_stage_6/delay_mid1
xlsub2_delay_mid1_out1 = xSignal('xlsub2_delay_mid1_out1');
xlsub2_delay_mid1 = xBlock(struct('source', 'Delay', 'name', 'delay_mid1'), ...
                           struct('latency', delay_arr(2)), ...
                           {xlsub2_Mux_out1}, ...
                           {xlsub2_delay_mid1_out1});

% block: fft_stage_n_improved/fft_stage_6/delay_start
xlsub2_delay_start = xBlock(struct('source', 'Delay', 'name', 'delay_start'), ...
                            struct('latency', delay_arr(1)), ...
                            {xlsub2_a}, ...
                            {xlsub2_delay_start_out1});

% block: fft_stage_n_improved/fft_stage_6/delay_start1
xlsub2_delay_start1 = xBlock(struct('source', 'Delay', 'name', 'delay_start1'), ...
                             struct('latency', delay_arr(1)), ...
                             {xlsub2_b}, ...
                             {xlsub2_delay_start1_out1});
...
if(FFTStage ==2)
    ...
    xlsub2_delay_end = xBlock(struct('source', 'Delay', 'name', 'delay_stg2_sel'), ...
                          struct('latency', delay_arr(2)), ...
                          {xlsub2_mux_sel}, ...
                          {sTwiddleSel});
