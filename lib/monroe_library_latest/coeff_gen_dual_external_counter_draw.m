function coeff_gen_dual_external_counter_draw(coeff, memory_type, bit_width, register_output)
...
sAddrSlice = xSignal;
sliceBits = log2(length(coeff)/2);
blockTemp = xBlock(struct('source', 'Slice', 'name', 'addr_slice'), struct('nbits', sliceBits, 'boolean_output','off', 'mode', 'Upper Bit Location + Width', 'base1', 'MSB of Input', 'base0', 'MSB of Input', 'bit1', 0), {iAddr}, {sAddrSlice});
...
xlsub2_Concat = xBlock(struct('source', 'Concat', 'name', 'Concat'), ...
                       [], ...
                       {xlsub2_Constant1_out1, sAddrSlice}, ...
                       {xlsub2_Concat_out1});
...
xlsub2_Concat1 = xBlock(struct('source', 'Concat', 'name', 'Concat1'), ...
                        [], ...
                        {xlsub2_Constant4_out1, sAddrSlice}, ...
                        {xlsub2_Concat1_out1});
