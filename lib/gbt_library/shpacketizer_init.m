function shpacketizer_init(blk, varargin)

defaults = {};

if same_state(blk, 'defaults', defaults, varargin{:}), return, end
disp('Running mask script for block: packetizer')
check_mask_type(blk, 'shpacketizer');
...
set_param([blk, '/shpacketizer_fsm'], 'defparams', ['{''data_per_word'',', num2str(words_per_cycle-1) ', ''n_words'', ' num2str(total_words-1), ' }']);
