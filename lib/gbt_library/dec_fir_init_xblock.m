...
xlsub2_imag_sum_sub = xBlock(struct('source',str2func('adder_tree_init_xblock_lib'), 'name', 'imag_sum'), ...
...
xlsub2_real_sum_sub = xBlock(struct('source', str2func('adder_tree_init_xblock_lib'), 'name', 'real_sum'), ...
                         {num_fir_col+1, add_latency,'off','off'}, ... %% for now just set them to off, ignore 'adder_tree_hdl'
