...
if n_inputs==1,
    ...
    xlsub2_adder_tree1=xBlock(struct('source',str2func('adder_tree_init_xblock'),'name','adder_tree1'), ...
                            {n_inputs,...
                             add_latency, ...
                             [],...
                             [],...
    ...
    xlsub2_adder_tree2=xBlock(struct('source',str2func('adder_tree_init_xblock'),'name','adder_tree2'), ...
                            {n_inputs,...
                             add_latency, ...
                             [],...
                             [],...
