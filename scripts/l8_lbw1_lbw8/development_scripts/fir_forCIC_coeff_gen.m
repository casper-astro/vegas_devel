%%%%% Copy from http://www.altera.com/literature/an/an455.pdf
...
f_range = 4; % how many times alias
...
dlmwrite(['dec', num2str(R), '_order', num2str(N), '_fir0', num2str(10*passband), '.txt'], h, ' ');
