...
boffile='l8_ver118_2013_Jun_01_1651.bof'
#boffile='l8_ver106_2013_Aug_25_2033.bof'

roach = 'vegasr2-1'

dest_ip  = 10*(2**24) + 17*(2**16) + 51 #10.17.0.51
src_ip   = 10*(2**24) + 17*(2**16) + 64 #10.17.0.64
...
for i in range(n_subbands):
    ...
    lo_f_actual[i], wave_tmp = l8_utils.lo_setup(fpga, ('s%d' % i), lo_freq=lo_f[i], fs=2*bw)
    time.sleep(t_sleep)
    setgain(i, 2**12, 2**14)
    time.sleep(t_sleep)
