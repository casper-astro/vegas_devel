...
function cichbcic_core_ver2_config(this_block)

  % Revision History:
  %
  %   04-Nov-2013  (11:43 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /opt/ptcs/scratch/models/gjones/vegas_devel/mdls/l8/cichbcic_core_ver2.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('cichbcic_core_ver2');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('cichbcic_core_ver2.vhd');
