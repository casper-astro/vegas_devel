...
function fft11_bb_config(this_block)

  % Revision History:
  %
  %   19-Feb-2013  (16:57 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /opt/ptcs/scratch/models/gjones/vegas_devel/mdls/mode01/fft11_bb.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('fft11_bb');


  this_block.addSimulinkInport('sync_in');
  this_block.addSimulinkInport('fftshift');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('fftshift').width ~= 32);
      this_block.setError('Input data type for port "fftshift" must have width=32.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('fft11_bb.vhd');
