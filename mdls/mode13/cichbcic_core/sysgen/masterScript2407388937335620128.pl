...
eval {
  ...
  my $instrs;
  my $results = [];
$ENV{'SYSGEN'} = '/tools/xilinx/14.2/ISE_DS/ISE/sysgen';
  use Sg;
  $instrs = {
    'HDLCodeGenStatus' => 0.0,
    'HDL_PATH' => '/tools/casper/projects/hong/my_vegas_devel/mode13',
    'TEMP' => '/tmp',
    'TMP' => '/tmp',
    'Temp' => '/tmp',
    'Tmp' => '/tmp',
    ...
    'coregen_core_generation_tmpdir' => '/tmp/sysgentmp-chenhong/cg_wk/c96ae4ce37205a6c3',
    ...
    'design' => 'cichbcic_core',
    'design_full_path' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core.mdl',
    'device' => 'xc6vsx475t-1ff1759',
    'device_speed' => '-1',
    'directory' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core',
    'dsp_cache_root_path' => '/tmp/sysgentmp-chenhong',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core/sysgen/perl_results.v', },
      ],
    ],
    'force_scheduling' => 0.0,
    'fxdptinstalled' => 1.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 206013.01501464844,
    'generating_subsystem_handle' => 206013.01501464844,
    'generation_directory' => './cichbcic_core',
    'hdlDir' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl',
    'hdlKind' => 'vhdl',
    'hdl_path' => '/tools/casper/projects/hong/my_vegas_devel/mode13',
    ...
    'isdeployed' => 0,
    'ise_version' => '14.2i',
    'master_sysgen_token_handle' => 206014.8154296875,
    'matlab' => '/tools/mathworks/matlabR2012a',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 206013.01501464844,
    'mdlPath' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core.mdl',
    'modelDiagnostics' => [
      {
        'count' => 1695.0,
        'isMask' => 0.0,
        'type' => 'cichbcic_core Total blocks',
      },
      {
        'count' => 17.0,
        'isMask' => 0.0,
    ...
    'model_path' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core.mdl',
    'myxilinx' => '/tools/xilinx/14.2/ISE_DS/ISE',
    'ngc_config' => {
      'include_cf' => 0.0,
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 206013.01501464844,
    ...
    'sysgen' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen',
    'sysgenRoot' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen',
    'sysgenTokenSettings' => {
      'base_system_period_hardware' => 6.6667,
      'base_system_period_simulink' => 1.0,
      'block_icon_display' => 'Default',
    ...
    'sysgen_Root' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen',
    'systemClockPeriod' => 6.6667,
    'tempdir' => '/tmp',
    'testbench' => 0,
    'tmpDir' => '/tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core/sysgen',
    'trim_vbits' => 1.0,
    'use_strict_names' => 1,
    'user_tips_enabled' => 0.0,
    'usertemp' => '/tmp/sysgentmp-chenhong',
    'using71Netlister' => 1,
    'verilog_files' => [
      'conv_pkg.v',
      'synth_reg.v',
    ...
    'xilinx' => '/tools/xilinx/14.2/ISE_DS/ISE',
    'xilinx_device' => 'xc6vsx475t-1ff1759',
  ...
  $instrs = [
    ...
    'CSET component_name = addsb_11_0_a6179ec1a236388e',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '8db28423b7fe87302d27ba60abff77ea',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(49 - 1 downto 0);
    clk: in std_logic:= \'0\';
    ce: in std_logic:= \'0\';
    ...
    b: in std_logic_vector(49 - 1 downto 0)',
      ...
      'entityName' => 'xladdsub_cichbcic_core',
  ...
  $instrs = [
    ...
    'CSET Sync_CE_Priority = Sync_Overrides_CE',
    'CSET Sync_Ctrl_Priority = Reset_Overrides_Set',
    'CSET component_name = addsb_11_0_5bfb73f1589643d3',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '316f762dd432e0c425874e26c5475b1a',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(52 - 1 downto 0);
    clk: in std_logic:= \'0\';
    ce: in std_logic:= \'0\';
    s: out std_logic_vector(c_output_width - 1 downto 0);
  ...
  $instrs = [
    ...
    'CSET Sync_CE_Priority = Sync_Overrides_CE',
    'CSET Sync_Ctrl_Priority = Reset_Overrides_Set',
    'CSET component_name = addsb_11_0_e35a3bf39f366fd8',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '5b233d362966101cae49da33bac6dc0d',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
  ...
  $instrs = [
    ...
    'CSET Sync_CE_Priority = Sync_Overrides_CE',
    'CSET Sync_Ctrl_Priority = Reset_Overrides_Set',
    'CSET component_name = addsb_11_0_5de09ee679db1560',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '6277054cad0c4429d928bf39440dbc6f',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(51 - 1 downto 0);
    clk: in std_logic:= \'0\';
    ce: in std_logic:= \'0\';
    s: out std_logic_vector(c_output_width - 1 downto 0);
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b58c0ea08b0a325d694b8cd109b40d47',
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd8b25a333b8e01dc11ede65b498483da',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'counter_4d9f59591b',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '5a1d1b86e524e4b2363708841e53e081',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_af078c6141',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
    ...
    'CSET component_name = mult_11_2_893416810381d560',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '6a0358c144fd55d5cefd6870991376ab',
    ...
    'templateKeyValues' => {
      ...
      'entityName' => 'xlmult_cichbcic_core',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '346bc88ae0c01b320a115434f33a0c7d',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_37b2f0b7ea',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '8d6bde262aa2aa336915b41191920dc1',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_d4111c362e',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'e9fca565b269aa3ef83298657f059f66',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_b0dd5d0cf3',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '49594bca0d88c130732406a05b74f1f7',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_32e8526bad',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'f715abd1d6b3ab7b6c21774101b9625d',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_6c8e1bed76',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'e72783e554301a1a4ba4c14f2bfd4f39',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '3d14d8fd7e4848a168e09245b0286a46',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_6eb5f4740f',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '8a642d8efcfb8e5ac60ec5f62aef3bac',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '8767b938974c5fe0408c43466173ddf2',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_b4fd6cc060',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '03e5b7ad6a6301f0185d73f38c134330',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'aac9ff41b42bc98e51f5cf6773455766',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_f6988cbd01',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'f1ec67eb71950ceb154179434d4ce5d5',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'aefd6928991e655859311f3d726434f9',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_7d1974bd4f',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '7334c9f67aab012288a4af53804b88fc',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_a6d6abc1fb',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'e83330c01a1029ac246d41134cfc2f0d',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '09c118cc9bddad08018feef335420a7e',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_2de4d085a7',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '7059a21e91ca0a47f45e66c7c773abbb',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'dc00a0d273775cbae532a90214fd15ac',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_78fc83082e',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'db8a0444005f2db5011e74cb9dfb0601',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'f02495bdc44fa6fc2e683527bc653ce7',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_2a7fe08e67',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '86dd38061ba55d469d7e85781c166e70',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_f1849463e9',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '58ef56c0a7818d014865cdac0cd991a0',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b390c9b699b57bd1ab4d377f4a9b29af',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_e63f1751f5',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'aee0677bcb4dad56905ee7a040fabe84',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '3064474f486f94d400104ec5ecaddf87',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_5d08e5a27e',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '8076155ef0ec21f3ca1633df52dc761b',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '714f87ab7efbeed00632c03195efe5ef',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_849323e8f6',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'a72aa7dd25f24bb44224b43153fbd486',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_f62aecf512',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '5edd812a098b297a45a20a9312595082',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '387e42224c8b891a6ea7018a03010b3f',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_fa63be3dfe',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'be57db24fef4615325e922b54cb985f8',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '5762977def6305cc39c2e0dd4846f00e',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_8f8925e093',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '6ed7d55e43ba53505984acf4b1280c4d',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd2fd5b510b81d874bea18f43ad2c5217',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_958f59c040',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '65ef23a8bf1f5a579845738cf10e5160',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '428aaf2dd96a54ab36c01f93c92edf8a',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '773c4eb452b79063b9665d27ead1b047',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_4b2650d0e6',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b12a5411b1a2cb9413e702a901718430',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_614a30f654',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '4d56a4a4b3cb1991ed8e9d49ad8be97b',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_b829aecccd',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '3e3e6a64b0a5a08ec03ba00f44dce26d',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_d65218df4d',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ea12e89ce831431ca25ef178277fa856',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'aad449d9ba16d887732b08cfb8c702c1',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '7e41e4137285fdb832e80cd898f8d624',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '7fef7d94124a9bde3e7f299625a2cb31',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = [
    'SELECT Binary_Counter virtex6 Xilinx_Inc. 11.0',
    '# 14.2_P.28xd',
    '# DEVICE virtex6',
    '# VHDL',
    'CSET ainit_value = 7',
    ...
    'CSET component_name = cntr_11_0_6400a835b899f648',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'cc932c87313a16f7757770d8a12739e5',
    ...
    'templateKeyValues' => {
      ...
      'entityName' => 'xlcounter_limit_cichbcic_core',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '285f6c9f79f2436ca0a3d40d1d7bd507',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_0c602bf0fd',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '8d04e1eae0d678305e139a83bd95e1dd',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '935402f6b25d1852fa8ba6b9b8d5f8da',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: signed((35 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_b17f382b30',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ecf920ebdb89490b4fdaac6d1d33638f',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: signed((36 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_1f7f5d69b1',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '5b4d24293c58a6be48fe2190a29f73b5',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: signed((37 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_619c589516',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '0f99de1fe34658f593d55318a727e4f6',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '5cda27dd344fb77076cf808248c1e27f',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '936b78d4a2e9534f0aebd45f35aa0975',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = [
    ...
    'CSET sync_threshold_output = false',
    'CSET syncctrlpriority = Reset_Overrides_Set',
    'CSET component_name = cntr_11_0_a0d692c18ceb283e',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '7b1f468088543e98c78b3c78a61ab788',
    'sourceFile' => 'hdl/xlcounter_limit.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '876b3770ae592dbcffb102fa9b54f65a',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_fda93ba512',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ff056d960d83d5ad4f90d431a0e81217',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '1f6a6ab1c239d4c1c5f229a2f539f311',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: signed((32 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_38883d04b4',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '1249c7a199ad837a291f323347db06bf',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: signed((33 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_20d573ab12',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '2b1641f2d836d9aa98bc0447489ccf98',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: signed((34 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'addsub_a3fafab502',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '62f8b5c7bd3f11989c6d6d26961cfc9b',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '9eb219fe24b5e2d39235507f8dcb3230',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '850acb84fb4a47da592e38e3a3c7e0f2',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ecf9f21f7f81c4480b6c247475683cb9',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '6f90b92b6c0a0541815560b4b704ff41',
    'sourceFile' => '/tools/xilinx/14.2/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '0688218adb5417c7e88542a4cb9e39c5',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'reinterpret_41e5bd5e40',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/tools/xilinx/14.2/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core/sysgen/script_results5256065237474955680') || 
    croak 'couldn\'t open /tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core/sysgen/script_results5256065237474955680';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /tools/casper/projects/hong/my_vegas_devel/mode13/cichbcic_core/sysgen/script_results5256065237474955680';
};
