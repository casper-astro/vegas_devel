...
function fftwbr_core_ver101_config(this_block)

  % Revision History:
  %
  %   12-Nov-2013  (10:09 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /opt/ptcs/scratch/models/gjones/vegas_devel/mdls/h16k/fftwbr_core_ver101.vhd
  %
  %
...
%  this_block.tagAsCombinational;
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('fftwbr_core_ver101.vhd');
